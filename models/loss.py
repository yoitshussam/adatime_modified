...
class SinkhornDistance(nn.Module):
    """
    Sinkhorn divergence (regularized optimal transport) between two point clouds.
    From: https://github.com/dfdazac/wassdist
    Used by RAINCOAT for domain alignment.
    """
    def __init__(self, eps=1e-3, max_iter=1000, reduction='sum'):
