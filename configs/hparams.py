    ...
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            "uDAR": {
                ...
                'weight_decay': 0.0001,
                        }, # Sweep: ACON_CNN  |  trg_risk: 0.6651  |  run: 0lxl0jx4
                'ACON': {
                    'batch_size': 32,
                    'learning_rate': 0.005,
                    'disc_lr': 0.01,
                    ...
                    'optimizer': 'adam',
                    'cls_trade_off': 3.695,
                    'domain_trade_off': 2.714,
                    'acon_disc_hid_dim': 128,
                    'align_s_trade_off': 4.883,
                    'align_t_trade_off': 3.517,
                    'entropy_trade_off': 0.006917,
                    'kl_reduction': 'mean',
                    'kl_t': 1.0,
                },

                # Sweep: CLUDA_CNN  |  trg_risk: 0.5497  |  run: a7c2m38x
                'CLUDA': {
                    'batch_size': 32,
                    'learning_rate': 0.005,
                    'disc_lr': 0.005,
                    ...
                    'weight_decay': 1e-05,
                    'optimizer': 'adam',
                    'src_cls_loss_wt': 3.001,
                    'domain_loss_wt': 3.217,
                },

                # Sweep: DAAN_CNN  |  trg_risk: 0.8730  |  run: 8473wpxj
                'DAAN': {
                    'batch_size': 32,
                    'learning_rate': 0.005,
                    'disc_lr': 0.0005,
                    ...
                    'weight_decay': 1e-05,
                    'optimizer': 'adam',
                    'src_cls_loss_wt': 3.179,
                    'global_loss_wt': 0.7385,
                    'local_loss_wt': 0.02181,
                },

                # Sweep: RAINCOAT_CNN  |  trg_risk: 1.1376  |  run: 12y1gr58
                'RAINCOAT': {
                    'batch_size': 64,
                    'learning_rate': 0.0001,
                    'disc_lr': 0.0005,
                    ...
                    'weight_decay': 1e-06,
                    'optimizer': 'adam',
                    'src_cls_loss_wt': 0.6372,
                    'domain_loss_wt': 0.6153,
                },

                # Sweep: SSSS_TSA_CNN  |  trg_risk: 0.3709  |  run: ljya3gvj
                'SSSS_TSA': {
                    'batch_size': 32,
                    'learning_rate': 0.005,
                    'disc_lr': 0.005,
                    ...
                    'weight_decay': 0.0001,
                    'optimizer': 'adam',
                    'src_cls_loss_wt': 4.558,
                    'domain_loss_wt': 2.747,
                    'tau_temp': 18,
                },
