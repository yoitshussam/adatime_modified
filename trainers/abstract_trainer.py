...
class AbstractTrainer(object):
   ...
   This class contain the main training functions for our AdAtime
    ...
    def __init__(self, args):
        ...
        self.source_dataset = args.source_dataset  # Selected  Dataset
        self.target_dataset = args.target_dataset # Selected  Dataset
        ...
        self.hparams = {
                                **self.hparams_class.alg_hparams[self.da_method],**self.hparams_class.train_params}
    ...
    def set_hparams(self,da_method):
                # Specify number of hparams
        self.hparams = {**self.hparams_class.alg_hparams[da_method],
    ...
    def evaluate(self, test_loader):
        ...
        with torch.no_grad():
            for batch in test_loader:
                ...
                # --- START FIX ---
                # Check if the algorithm follows the standard Fframework
                if (self.da_method=='uDAR'):
    ...
    def load_data(self):
        ...
        dataloaders = data_generator(self.source_data_path, self.dataset_configs, self.hparams,'source')
        self.src_train_dl=dataloaders[0]
        self.src_test_dl=dataloaders[1]
        self.src_val_dl=dataloaders[2]
        ...
        dataloaders = data_generator(self.target_data_path, self.dataset_configs, self.hparams, 'target')
        self.trg_train_dl=dataloaders[0]
        self.trg_test_dl=dataloaders[1]
        ...
        print("-------------------------------\n")
        if(self.da_method=="uDAR"):
            self.trg_train_dl.dataset.return_index = True
    ...
    def calculate_metrics(self):
        ...
        # f1
        src_f1 = self.F1(self.full_preds.argmax(dim=1).cpu(), self.full_labels.cpu()).item()
        # auroc 
        src_auroc = self.AUROC(self.full_preds.cpu(), self.full_labels.cpu()).item()


        return trg_acc, trg_f1, trg_auroc, src_acc, src_f1, src_auroc
