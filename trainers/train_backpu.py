...
class Trainer(AbstractTrainer):
   ...
   This class contain the main training functions for our AdAtime
    ...
    def fit(self):
        ...
        # Trainer
        mlflow.set_experiment(f"{self.source_dataset}-->{self.target_dataset}")
    ...
    def test(self):
        ...
        for run_id in range(self.num_runs):
            ...
            # Logging
            self.scenario_log_dir = os.path.join(self.exp_log_dir, self.source_dataset + "_to_" + self.target_dataset + "_run_" + str(run_id))
            ...
            last_results = self.append_results_to_tables(last_results, f"{self.source_dataset}_to_{self.target_dataset}", run_id,
                                                            last_metrics)
            ...
            # Append results to tables
            best_results = self.append_results_to_tables(best_results, f"{self.source_dataset}_to_{self.target_dataset}", run_id,
                                                            best_metrics)
