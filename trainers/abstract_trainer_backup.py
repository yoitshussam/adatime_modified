...
# get_dataset_class(self.source_dataset),get_hparams_class(self.source_dataset)
    ...
    def load_data(self):
        self.src_train_dl = data_generator(self.source_data_path, self.dataset_configs, self.hparams, "train")
        self.src_test_dl = data_generator(self.source_data_path, self.dataset_configs, self.hparams, "test")

        self.trg_train_dl = data_generator(self.target_data_path, self.dataset_configs, self.hparams, "train")
        self.trg_test_dl = data_generator(self.target_data_path, self.dataset_configs, self.hparams, "test")
